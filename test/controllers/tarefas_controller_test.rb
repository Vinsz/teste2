...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { aberta: @tarefa.aberta, listum_id: @tarefa.listum_id, texto: @tarefa.texto } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { aberta: @tarefa.aberta, listum_id: @tarefa.listum_id, texto: @tarefa.texto } }
